...
# Aca es donde se escoge que tipo de datos se quiere usar, normalizaos, shufleados (en caso de validation) o solo hasta casteados
    
    for i in range(0, len(datostranspuestosfiltrados)):
        dataset_t[i] = datostranspuestosfiltradoscasteadosnormalizados[i][4]
        for j in range(0, len(datostranspuestosfiltrados[0])-1):
